...
const routes = [
  ...
  },
  {
    ...
    component: () =>
      import("../views/super-admin/ShowFeedbackMessages.vue"),
      beforeEnter: () => routeGuardFunc(SUPER_ADMIN),
  },
  {
  ...
  },
  {
    ...
    name: "show-paid-room",
    component: () =>
      import("../views/admin/ShowPaidRoom.vue"),
      beforeEnter: () => routeGuardFunc(ADMIN),
  },
  {
    ...
    component: () =>
      import("../views/admin/ShowPaidObject.vue"),
      beforeEnter: () => routeGuardFunc(ADMIN),
  },
  {
    ...
    component: () =>
      import("../views/admin/ShowPaidHotelHall.vue"),
      beforeEnter: () => routeGuardFunc(ADMIN),
  },
  {
    path: "/404",
    name: "page-not-found",
    component: () =>
      import("../views/errors/page404.vue"),
  },
  { 
    path: '/:pathMatch(.*)', 
    redirect: '/404' 
