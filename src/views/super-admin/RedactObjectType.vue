    ...
    <div class="form-fauna-flora">
        ...
        <div class="formbox">
            <form>
              ...
              <br>
              <input v-model="objectType.price" type="number" step="any" min=0 style="width:100%" id="price"><br> 

              <label for="priceper">Введите цену за последующие часы:</label>
              <br>
              <input v-model="objectType.pricePerHour" type="number" step="any" min=0 style="width:100%" id="priceper"><br> 
              
              <label for="priceper">Введите минимальное время:</label>
              <br>
              <input v-model="objectType.minHours" type="number" step="any" min=0 style="width:100%" id="priceper"><br> 
            </form>
        </div>
...
export default {
    ...
    methods: {
      ...
      update(){
            axios
            .put("http://localhost:8083/object/type/update",
              this.objectType, 
              {
                headers:{
