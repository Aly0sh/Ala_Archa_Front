<template>
    <div class="container">
		<div class="services-head">
			...
			<img :src="getImgUrl(slidesHead[0])" @click="clickToHead(slidesHead[0], 0)" class="services-head-fr" alt="">
		</div>
...
export default {
	...
	mounted(){
    axios
      .get("http://alaarcha2.inai.kg:8083/hotel/get-all")
    ...
    axios
      .get("http://alaarcha2.inai.kg:8083/object/type/get-all")
