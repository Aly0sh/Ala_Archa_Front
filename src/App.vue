<template>
  <nav>
    ...
    <div @click.self="dropdown = !dropdown" v-if="dropdown" style="
        position: fixed;
        top: 0;
        left: 0;
        min-height: 100%;
    ...
    <div class="navbar">
        <div class="menu">
            <div class="burger" @click="burger = !burger">
              <div class="burger-line"    :class="burger ? 'f-burg-line-active':'f-burg-line'"/>
              <div class="burger-line"    :class="burger ? 's-burg-line-active':'s-burg-line'"/>
              <div class="burger-line"    :class="burger ? 't-burg-line-active':'t-burg-line'"/>
            </div>
            
        </div>
        <div class="logo">
            <img style="z-index: 2; position:relative;" :src="require('./assets/img/icons/logo.png')" @click="$router.push('/')" alt="logo">
        </div>
        <ul class="green font">
            <li><router-link to="/">Главная</router-link></li>
            <li><a @click="dropdown = !dropdown" style="position: relative;">О нас<img :class="dropdown? 'arrow-active' : 'arrow-not-active'" class="arrow" src="./assets/img/icons/arrow-down.svg" alt=""> 
            <div class="dropdown-about-us" v-show="dropdown">
              <router-link to="/about-us" style="padding: 1vw 25px 0.7vw 25px;">История</router-link>
              <hr>
              <router-link to="/flora" style="padding: 0.7vw 25px;">Флора</router-link>
              <hr>
              <router-link to="/fauna" style="padding: 0.7vw 25px 1vw 25px;">Фауна</router-link>
            </div></a></li>
